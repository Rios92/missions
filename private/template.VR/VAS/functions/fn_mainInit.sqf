...
[] spawn
{
	if(isNil "VAS_init_complete") then
	{
		...
		if(isNil "VAS_Local_fnc_buildConfig") exitWith {diag_log "::VAS:: function VAS_Local_fnc_buildConfig is nil"};
		["CfgWeapons"] call VAS_Local_fnc_buildConfig;
		["CfgMagazines"] call VAS_Local_fnc_buildConfig;
		["CfgVehicles"] call VAS_Local_fnc_buildConfig;
		["CfgGlasses"] call VAS_Local_fnc_buildConfig;
