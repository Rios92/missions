...
Optional Parameters:
    ...
    Hide         Array          Hiding does not prevent the units from detecting and engaging enemies. It's only meant to be used for preventing the units being detected from far away.
