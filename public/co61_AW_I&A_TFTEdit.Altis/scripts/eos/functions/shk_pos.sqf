...
Parameters for relative position:
    ...
    Water solution    Integer             Water positions not allowed, what to do?
        ...
        1: Find closest land. Search is done with increasing radius until land is found, thus the resulting position might not be exactly in the given direction and distance.
