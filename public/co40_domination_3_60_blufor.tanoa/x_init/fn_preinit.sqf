...
if (_isserv_or_hc) then {
	...
	d_allmen_E = [
#ifdef __ALTIS__
#include "d_allmen_E_default.sqf"
#endif
#ifdef __CUP_CHERNARUS__
#include "d_allmen_E_CUP_CHER.sqf"
#endif
#ifdef __CUP_TAKISTAN__
#include "d_allmen_E_CUP_TAKI.sqf"
#endif
#ifdef __CUP_SARA__
#include "d_allmen_E_CUP_SLA.sqf"
#endif
#ifdef __TT__
if (!d_tt_tanoa) then {
#include "d_allmen_E_default.sqf"
} else {
#include "d_allmen_E_tanoa.sqf"
}
#endif
#ifdef __TANOA__
#include "d_allmen_E_tanoa.sqf"
...
#include "d_allmen_E_default.sqf"
	...
	d_specops_E = [
#ifdef __ALTIS__
#include "d_specops_E_default.sqf"
#endif
#ifdef __CUP_CHERNARUS__
#include "d_specops_E_CUP_CHER.sqf"
#endif
#ifdef __CUP_TAKISTAN__
#include "d_specops_E_CUP_TAKI.sqf"
#endif
#ifdef __CUP_SARA__
#include "d_specops_E_CUP_SLA.sqf"
#endif
#ifdef __TT__
if (!d_tt_tanoa) then {
#include "d_specops_E_default.sqf"
} else {
#include "d_specops_E_tanoa.sqf"
}
#endif
#ifdef __TANOA__
#include "d_specops_E_tanoa.sqf"
...
#include "d_specops_E_default.sqf"
	...
	d_veh_a_E = [
#ifdef __ALTIS__
#include "d_veh_a_E_default.sqf"
#endif
#ifdef __CUP_CHERNARUS__
#include "d_veh_a_E_CUP_CHER.sqf"
#endif
#ifdef __CUP_TAKISTAN__
#include "d_veh_a_E_CUP_TAKI.sqf"
#endif
#ifdef __CUP_SARA__
#include "d_veh_a_E_CUP_SARA.sqf"
#endif
#ifdef __TT__
if (!d_tt_tanoa) then {
#include "d_veh_a_E_default.sqf"
} else {
#include "d_veh_a_E_tanoa.sqf"
}
#endif
#ifdef __TANOA__
#include "d_veh_a_E_tanoa.sqf"
...
#endif
#ifdef __OWN_SIDE_BLUFOR__
	[["B_Quadbike_01_F"], ["B_Quadbike_01_F", "B_T_LSV_01_unarmed_F"]] select d_tanoa;
#endif
#ifdef __OWN_SIDE_OPFOR__
	[["O_Quadbike_01_F"], ["O_Quadbike_01_F", "O_T_LSV_02_unarmed_F"]] select d_tanoa;
#endif
#ifdef __TT__
	["O_Quadbike_01_F"];
#endif
