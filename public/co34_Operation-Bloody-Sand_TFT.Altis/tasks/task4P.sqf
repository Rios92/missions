...
_taskNumber = 4;
_taskMarker = "Pyrgos";	// marker name "Agia_Marina"
_taskPlace = "Pyrgos";		// string "Agia Marina"
...
{                
     ...
     if(isServer) then  
	{
		...
		// CUSTOM UNITS
		["east", [20345.9,11837.1,0.00156403], 10, "ISIS" , true , grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east", [20325.9,11825.2,0.00180817], 10, "ISIS" , true , grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east", [20217.8,11767.3,0.00143814], 28, "ISIS" , true , grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east", [20214.3,11770.2,0.00143814], 30, "ISIS" , true , grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		...
		//if (logging_mode) then {["task4.sqf",4,format ["AI skill: %1",skill (_missionUnits select 0)]] spawn FFS_FNC_log;};
