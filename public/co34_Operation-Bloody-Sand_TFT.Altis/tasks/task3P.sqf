...
_taskNumber = 3;
_taskMarker = "Dorida";	// marker name "Agia_Marina"
_taskPlace = "Dorida";		// string "Agia Marina"
...
_minSurUnits = 7;
_rnfArray = ["west",8,10,240,[19498.9,13020.8,0], [19899.9,11693.1,0],16];	// friendly side, min.units,max.units,sleep(loop),create pos,unload pos, min.units in area for activation	
...
{                
     ...
     if(isServer) then  
	{
		...
		// CUSTOM UNITS
		["east", [19237.1,13302.4,0.0015831], 270, "ISIS" , true ,grpNull , game_difficulty] call FFS_FNC_crateStaticUnit;
		["east", [19405.5,13258.4,0.0014419], 329, "ISIS" , true ,grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east", [19394,13239.1, 0.00145721], 251, "ISIS" , true ,grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east", [19413.5,13248.2,0.0014305], 42, "ISIS" , true ,grpNull , game_difficulty ] call FFS_FNC_crateStaticUnit;
		["east",[19403,13252.8,-0.0454292],0,"","ISIS",game_difficulty] call FFS_FNC_crateStaticVeh;		
		
		flag3 setFlagTexture "pics\ISIS_flag3.jpg";
		
		// CAPTURE LIST OF UNITS + LOGGING
		sleep 0.5;
		_missionUnits = +(list _trg);	
		//if (logging_mode) then {["task3.sqf",4,format ["AI skill: %1",skill (_missionUnits select 0)]] spawn FFS_FNC_log;};
