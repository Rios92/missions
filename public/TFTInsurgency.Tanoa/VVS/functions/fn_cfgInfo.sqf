...
_displayName = format["%1 (%2sec)", getText(configFile >> "CfgVehicles" >> _class >> "displayName"), (VVS_Cost select {(_x select 0) == VVS_classname_temp}) select 0 select 1];
