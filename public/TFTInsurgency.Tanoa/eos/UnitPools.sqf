...
// EAST CSAT FACTION with frankie edits
	if (_faction==0) then {
	_InfPool=	["O_T_Recon_Exp_F","O_T_Soldier_TL_F","O_T_Soldier_LAT_F","O_T_Engineer_F","O_T_Medic_F","O_T_Soldier_AR_F","O_T_Soldier_A_F","O_T_Recon_M_F","O_T_Recon_JTAC_F","O_T_Soldier_SL_F","O_T_Soldier_F","O_T_Soldier_Repair_F","O_T_Officer_F","O_T_Soldier_GL_F","O_T_Recon_LAT_F","O_T_Recon_F","O_T_Spotter_F","O_T_ghillie_tna_F","O_T_Sniper_F"];	
	_ArmPool=	["O_T_APC_Tracked_02_cannon_ghex_F","O_T_APC_Wheeled_02_rcws_ghex_F","O_T_APC_Tracked_02_AA_ghex_F"];
	_MotPool=	["O_T_LSV_02_unarmed_F","O_T_LSV_02_armed_F","O_T_MRAP_02_hmg_ghex_F","O_T_MRAP_02_gmg_ghex_F","O_T_MRAP_02_ghex_F","O_T_Truck_03_transport_ghex_F"];
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Light_02_v2_F"];
	_CHPool=	["O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F"];
	_uavPool=	["O_T_UAV_04_CAS_F","O_UAV_01_F"];
	_stPool=	["O_Mortar_01_F","O_HMG_01_high_F","O_static_AT_F","O_GMG_01_high_F"];
	_shipPool=	["O_T_Boat_Armed_01_hmg_F","O_T_Boat_Transport_01_F"];
	_diverPool=	["O_T_Diver_F","O_T_Diver_Exp_F","O_T_Diver_TL_F"];
	_crewPool=	["O_T_Crew_F","O_T_Engineer_F"];
	_heliCrew=	["O_T_Helipilot_F","O_T_Helicrew_F"];
};
// WEST NATO FACTION
	if (_faction==1) then {
