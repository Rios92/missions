...
class VAS_Diag {
	...
	class controlsBackground {
		...
		class VAS_UniformPicSlot : VAS_ActiveTextPicture
		{
			idc = 2960;
			text = "";
			onLBDrop = "_this call VAS_Local_fnc_quickAddDrag;";
			x = 0.905;
			y = 0.25;
	...
	class controls {
		...
		class AttachmentsList : VAS_RscListBox
		{
			...
			idc = 2851;
			text = "";
			onLBDblClick = "_this call VAS_Local_fnc_quickAttachment";
			canDrag = 1;
			sizeEx = 0.035;
			x = -0.2; y = 0.47 + (11 / 250);
		...
		class gundetailslist : VAS_RscListBox
		{
			...
			text = "";
			canDrag = 1;
			onLBDblClick = "_this spawn VAS_Local_fnc_quickMag;";
			sizeEx = 0.030;
		...
		class vasGear : VAS_RscListBox
		{
			...
			sizeEx = 0.032;
			canDrag = 1;
			onLBSelChanged = "_this spawn VAS_Local_fnc_details";
			onLBDblClick = "_this spawn VAS_Local_fnc_quickItem;";
		...
		class vasPGear : VAS_RscListBox
		{
			...
			text = "";
			sizeEx = 0.032;
			onLBDblClick = "_this spawn VAS_Local_fnc_qRemoveItem;";
		...
		class WeaponsBtn : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['guns',false] spawn VAS_Local_fnc_mainDisplay";
			x = 0.42; y = 0.30;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class MagazinesBtn : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['mags',false] spawn VAS_Local_fnc_mainDisplay";
			x = 0.42; y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class ItemsBtn : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['items',false] spawn VAS_Local_fnc_mainDisplay";
			x = 0.42; y = 0.40;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class BackpacksBtn : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['packs',false] spawn VAS_Local_fnc_mainDisplay";
			x = 0.42; y = 0.45;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class GogglesBtn : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['glass',false] spawn VAS_Local_fnc_mainDisplay";
			x = 0.42; y = 0.50;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class Filter1 : VAS_RscActiveText
		{
			...
			action = "[0] spawn VAS_Local_fnc_filterMenu";
			sizeEx = 0.04;
		...
		class Filter2 : VAS_RscActiveText
		{
			...
			action = "[1] spawn VAS_Local_fnc_filterMenu";
			sizeEx = 0.04;
		...
		class Filter3 : VAS_RscActiveText
		{
			...
			action = "[2] spawn VAS_Local_fnc_filterMenu";
			sizeEx = 0.04;
		...
		class Filter4 : VAS_RscActiveText
		{
			...
			action = "[3] spawn VAS_Local_fnc_filterMenu";
			sizeEx = 0.04;
		...
		class Filter5 : VAS_RscActiveText
		{
			...
			action = "[4] spawn VAS_Local_fnc_filterMenu";
			sizeEx = 0.04;
		...
		class ButtonAddG : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] spawn VAS_Local_fnc_addGear";
		...
		class ButtonRemoveG : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[false] spawn VAS_Local_fnc_removeGear;";
		...
		class ButtonRemoveAll : VAS_RscButtonMenu {
			...
			onButtonClick = "[true] spawn VAS_Local_fnc_removeGear;";
...
class VAS_Load_Diag {
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[1] spawn VAS_Local_fnc_SaveLoad";
	...
	class controls {
		...
		class LoadLoadoutList : VAS_RscListBox
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[1] spawn VAS_Local_fnc_loadoutInfo";
		...
		class LoadOnRespawnMenu : VAS_RscButtonMenu {
			...
			onButtonClick = "if(vas_onRespawn) then {[] call VAS_Local_fnc_onRespawn;} else {hint ""Disabled""};";
		...
		class TransBtn : VAS_RscButtonMenu
		{
			...
			onButtonClick = "[] call VAS_Local_fnc_transferMenu";
		...
		class GearLoadMenu : VAS_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] spawn VAS_Local_fnc_loadGear";
		...
		class GearDeleteMenu : VAS_RscButtonMenu
		{
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] spawn VAS_Local_fnc_deleteGear";
		...
		class MainMenu : VAS_RscControlsGroup
		{
			...
			class Controls
			{
				...
				class TransBtn : VAS_RscButtonMenu
				{
					idc = -1;
					text = "$STR_VAS_Load_TransferBtn";
					onButtonClick = "[] call VAS_Local_fnc_transferAction";
		...
		class TransferSaveMenu : VAS_RscControlsGroup
		{
			...
			class Controls
			{
				...
				class GearSaveMenu : VAS_RscButtonMenu
				{
					...
					colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
					onButtonClick = "[] call VAS_Local_fnc_transferSaveGear";
...
class VAS_Save_Diag {
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[0] spawn VAS_Local_fnc_SaveLoad";
	...
	class controls
	{
		...
		class SaveLoadoutList : VAS_RscListBox
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[0] spawn VAS_Local_fnc_loadoutInfo";
		...
		class GearSaveMenu : VAS_RscButtonMenu {
			...
			text = "$STR_VAS_Save_btnSave";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call VAS_Local_fnc_saveGear";
			x = 0.35 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.73 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
