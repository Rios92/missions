...
switch(_filter) do
{
	case "guns":
	{
		switch(_req) do
		{
			case 0: {_data = [_filter,1] call VAS_Local_fnc_fetchCfg; _myfilter = 1;};
			case 1: {_data = [_filter,1] call VAS_Local_fnc_fetchCfg; _myfilter = 1;};
			case 2: {_data = [_filter,5] call VAS_Local_fnc_fetchCfg; _myfilter = 5;};
			case 3: {_data = [_filter,4] call VAS_Local_fnc_fetchCfg; _myfilter = 4;};
			case 4: {_data = [_filter,2] call VAS_Local_fnc_fetchCfg; _myfilter = 2;};
		};
	};
	...
	case "items":
	{
		switch(_req) do
		{
			case 0: {_data = [_filter,801] call VAS_Local_fnc_fetchCfg; _myfilter = 801;};
			case 1: {_data = [_filter,701] call VAS_Local_fnc_fetchCfg; _myfilter = 701;};
			case 2: {_data = [_filter,605] call VAS_Local_fnc_fetchCfg; _myfilter = 605;};
			case 3: 
			{
				_data = [_filter,[201,101,301,302]] call VAS_Local_fnc_fetchCfg;
				_myfilter = [201,101,301,302];
			};
			case 4: {_data = [_filter,[0,616,621,619,620,401]] call VAS_Local_fnc_fetchCfg; _myfilter = [0,616,621,619,620,401];};
		};
	};
};
...
if(_return) then
{
	_info = [([] call VAS_Local_fnc_fetchPlayerGear),_myfilter] call VAS_Local_fnc_filter;
	_info;
}
	else
{
	...
	{
		_details = [_x] call VAS_Local_fnc_fetchCfgDetails;
