...
{
	case "All": {(VVS_pre_Car + VVS_pre_Ship + VVS_pre_Armored + VVS_pre_Support + VVS_pre_Autonomous)};
...
if((player getUnitTrait "derp_pilot") && {_filter in ["Air", "All"]}) then {
    _vehicleList = _vehicleList + VVS_pre_Air;
};
