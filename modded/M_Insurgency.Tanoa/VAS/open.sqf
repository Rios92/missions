...
if(!VAS_init_complete && !vas_disableSafetyCheck) exitWith {if((time - VAS_init_timeOnStart) > 25) then {[] call VAS_Local_fnc_mainInit;}; hint "VAS hasn't finished loading yet."};
...
["guns",false] spawn VAS_Local_fnc_mainDisplay; 
ctrlShow [2507,false];
ctrlShow [2508,false];
ctrlShow [2509,false];
ctrlShow [2850,false];
