...
*/
VAS_Local_pre_items_uniforms = [];
VAS_Local_pre_items_vests = [];
VAS_Local_pre_items_headgear = [];
VAS_Local_pre_items_attachments = [];
VAS_Local_pre_items_misc = [];
VAS_Local_pre_weapons_rifles = [];
VAS_Local_pre_weapons_heavy = [];
VAS_Local_pre_weapons_launchers = [];
VAS_Local_pre_weapons_pistols = [];
